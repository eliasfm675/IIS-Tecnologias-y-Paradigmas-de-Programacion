...
namespace Modelo
{
    public static class ProcesadorTextos
    {
        ...
        public static int Palabra(string[] palabras, string palabra)
        {
            int counter = 0;
        ...
        public static void MostrarResultados(int signosPuntuacion, string[] palabrasMasCortas, string[] palabrasMasLargas,
                                       ...
                                       string[] PalabrasAparecenMasVeces, int masRepeticiones, string palabraVeces, int totalVeces)
        {
            ...
            Console.WriteLine();
            Console.Write("> {0} es la palabra que más veces aparece, con un total de ({1}): ", palabraVeces, totalVeces);
            Console.WriteLine();
        }
        public static void ShowWordParallel(string palabraVeces, int totalVeces)
        {
            Console.Write(">Versión Paralela --> {0} aparece un total de ({1}) veces: ", palabraVeces, totalVeces);
            Console.WriteLine();
        }
        public static void ShowWordParallelPLINQ(string[] palabraVeces, string palabra)
        {
            Console.Write(">Versión PLINQ --> {0} aparece un total de ({1}) veces: ",palabra,  palabraVeces.AsParallel().Count(x => x.Equals(palabra)));
            Console.WriteLine();
        }
