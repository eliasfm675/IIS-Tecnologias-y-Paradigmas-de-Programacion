...
namespace _01HerenciaPolimorfismo
{
    class Program
    {
        static void Main()
        {
            ...
            Animal pato = new Pato("Cuack", 20); //se llama los métodos de la clase izquierda(Animal) a no ser que tenga habilitado el enlace dinámico
            ...
            //Operador ??. Si no tiene valor (es decir, es null) asigna el especificado. En este caso 10.00 .
        ...
        public static Modelo.IComparable Max(Modelo.IComparable a, Modelo.IComparable b) //si quito el Modelo. se me pone la clase de C#, pero queremos usar nuestra propia clase
        {
