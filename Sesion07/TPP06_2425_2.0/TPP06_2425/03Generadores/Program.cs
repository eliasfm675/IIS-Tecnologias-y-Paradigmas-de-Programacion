...
namespace _03Generadores
{
    public static class Program
    {
        static void Main(string[] args)
        {
            ...
            //iterador.Reset(); // <- ¡OJO! El reset no está soportado. porque es potencialmente infinito al ser lazy(Ienumerable generado por el yield)
            iterador = Funciones.FibonacciInfinito().GetEnumerator();
            Console.WriteLine();
            ...
            IEnumerable<int> imparesLazy = Funciones.NumerosImparesLazy(desde, cantidad);//esto no se ejecuta hasta el foreach, no como en el eager que se ejecuta al instante
            ...
            //Uso de Memorización // Memoization
