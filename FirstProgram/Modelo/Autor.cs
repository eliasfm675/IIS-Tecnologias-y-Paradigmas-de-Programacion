...
namespace Modelo
{
    ...
    public class Autor
    {
        ...
        public Autor(string nombre, string apellido)
        {
            ...
            Nombre = nombre;
            Apellido = apellido;
            CreatedAt = DateTime.Now; //al ser solo lectura, solo se puede inicializar o cambiar en el constructor
#if DEBUG //esto solo se ejecuta si estamos depurando o lo que es lo mismo en modo DEBUG
