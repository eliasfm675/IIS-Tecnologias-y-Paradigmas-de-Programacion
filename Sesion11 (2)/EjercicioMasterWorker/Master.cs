...
namespace EjercicioMasterWorker
{
    public class Master
    {
        ...
        private int value;
        private ConcurrentBag<double> result = new ConcurrentBag<double>();
        ...
        public IList<double> Resolve()
        {
            ...
            for (int i = 0; i < this.numThreads; i++)
            {
                ...
                ws[i] = new Worker(this.vector, startIndex, endIndex, value, result);
            }
