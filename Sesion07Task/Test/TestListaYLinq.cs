...
namespace TestLista
{
    ...
    public class TestListaYLinq
    {
        ...
        public void TestBuscar()
        {
            ...
            Persona p1 = new Persona("0", "pepe", "90");
            Persona p2 = new Persona("1", "chema", "88");
            Persona p3 = new Persona("2", "mauricio", "44");
            Persona p4 = new Persona("3", "jose", "45");
            l.Anadir(p1);
            l.Anadir(p2);
            l.Anadir(p3);
            l.Anadir(p4);
            Assert.AreEqual(p3, l.Buscar(p3));
